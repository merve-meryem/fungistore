...
export default function Hakkımızda() {
  return (
    <div>
      <h1 className='text-2xl font-extrabold p-6 text-lime-500'> Hakkımızda</h1>
      <img  src={mantar} />
    <div className='text-md font-sans antialiased italic text-justify mt-10 text-yellow-700 bg-fuchsia-50'>
      <p>
